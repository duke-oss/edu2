  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gray-50 border-b border-gray-100 py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-blue-600 font-semibold text-sm mb-2">수입 소싱 교육</p>
          ...
          {courses.map((course) => (
            ...
            >
              ...
              <div className="px-6 pb-5">
                <div className="flex items-center text-blue-600 text-sm font-semibold group-hover:gap-2 gap-1 transition-all">
