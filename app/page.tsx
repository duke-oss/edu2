      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-center">
              <div className="lg:col-span-6 text-center lg:text-left">
                ...
                <p className="mt-4 text-lg text-gray-600 mb-10 max-w-2xl mx-auto lg:mx-0">
              ...
              <div className="lg:col-span-6 mt-16 lg:mt-0 relative">
                ...
                <div className="relative rounded-2xl bg-gray-900 shadow-2xl overflow-hidden aspect-[4/3] transform transition-transform hover:scale-[1.02] duration-500">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 h-64 flex items-end px-8 pb-8 space-x-2 opacity-80">
                    {[40, 60, 45, 70, 50, 85, 60, 95, 75, 110, 85, 120, 95, 140, 110, 160].map((h, i) => (
                      <div key={i} className="flex-1 bg-gradient-to-t from-cyan-500 to-blue-500 rounded-t-sm" style={{ height: `${h}px` }}></div>
                    ))}
                  </div>
              ...
              {[
                ...
                <div key={i} className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <p className="text-sm font-medium text-emerald-600 flex items-center">
                    {/* Tiny upward trend arrow inside trend text ideally, but text includes it */}
                    {stat.trend}
                  </p>
                </div>
              ))}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm hover:shadow-lg transition-all hover:-translate-y-1 flex flex-col h-full group">
                  ...
                  {[
                    {
                      year: "2018",
                      title: "2018 창립",
                      desc: "전통적인 국제 무역 프로세스의 디지털 격차를 해소하려는 미션으로 셀러노트가 설립되었습니다.",
                    },
                    {
                      year: "2020",
                      title: "2020 쉽다 서비스 런칭",
                      desc: "물류 최적화 분야로 확장하여 기업에 실시간 배송 추적 및 비용 분석 서비스를 제공하기 시작했습니다.",
                    },
                    {
                      year: "2021",
                      title: "2021 글로벌 확장",
                      desc: "4개 대륙 50개국 이상의 파트너에게 서비스를 제공하는 주요 이정표를 달성했습니다.",
                    },
                    {
                      year: "2023",
                      title: "2023 생태계 완성",
                      desc: "위딜러를 출시하여 서류 작업, 물류, 거래를 아우르는 완전한 SaaS 제품군을 완성했습니다.",
                    }
                  ].map((item, i) => (
        ...
        <section className="py-24 bg-white relative">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-blue-600 rounded-3xl p-10 md:p-16 text-center text-white shadow-xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <a
                    href="#"
                    className="inline-flex items-center justify-center px-8 py-4 border border-transparent text-base font-bold rounded-full text-blue-600 bg-white hover:bg-gray-50 shadow-md transition-all hover:shadow-lg hover:-translate-y-0.5"
                  >
                    지금 시작하기
                  </a>
                  <a
                    href="#"
                    className="inline-flex items-center justify-center px-8 py-4 border border-blue-400 text-base font-bold rounded-full text-white bg-transparent hover:bg-blue-700 transition-all"
                  >
                    영업팀 문의
                  </a>
                </div>
